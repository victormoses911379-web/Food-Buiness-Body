    ...
    await db.collection('payments').doc(docId).set(
      {
        ...
        flutterwaveTransactionId: paymentData.flutterwave_transaction_id || paymentData.flutterwaveTransactionId || null,
        flutterwaveTxRef: paymentData.flutterwave_tx_ref || paymentData.flutterwaveTxRef || null,
        flutterwaveFlwRef: paymentData.flutterwave_flw_ref || null,
        verificationStatus: paymentData.verification_status || paymentData.verificationStatus || 'PENDING',
        paidAt: paymentData.paid_at || paymentData.paidAt || null,
        verifiedAt: paymentData.verified_at || paymentData.verifiedAt || null,
